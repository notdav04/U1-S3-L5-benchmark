...
*/
me.skills = ["JavaScript", "c#", "python"];
console.log(me);

/* ESERCIZIO F
  Crea un pezzo di codice per aggiungere un nuovo elemento all'array "skills" contenuto nell'oggetto "me".
*/
me.skills.push("elemento aggiunto");
console.log(me);
/* ESERCIZIO G
...
*/
const whoIsBigger = function (number_1, number_2) {
...
console.log(whoIsBigger(124, 78));
/* ESERCIZIO 3
...
console.log(deleteOne("davide", false));
/* ESERCIZIO 5
...
console.log(onlyLetters("ho 2 cani"));
...
const isThisAnEmail = function (string) {
  if (string.includes("@") && string.includes(".") && !string.includes(" ")) {
    ...
    console.log("non hai inserito una email valida");
  }
};

isThisAnEmail("davide@epicode.com");
/* ESERCIZIO 7
...
const howManyDays = function () {
  const date1 = new Date("2024-10-17");
  const today = new Date();

  const Milli_difference = today - date1;
  const day_difference = Math.floor(Milli_difference / (1000 * 60 * 60 * 24));
...
const isTodayMyBirthday = function () {
  const oggi = new Date();
  const birthday = new Date("2004-04-26");

  if (
    oggi.getDay() === birthday.getDay() &&
    oggi.getMonth() === birthday.getMonth()
  ) {
    consnole.log("oggi è il tuo compleanno");
  } else {
...
const deleteProp = function (obj, string) {
  const result = delete obj.string;
  return result;
};

console.log(deleteProp(obj, "eta"));
...
searchAndDivide(movies, "Flies");
/* ESERCIZIO 19
  Scrivi una funzione chiamata "removeIndex" che riceve un numero come parametro e ritorna l'array "movies" fornito privo dell'elemento nella posizione ricevuta come parametro.
*/

const removeIndex = function (array, n) {
  array.splice(n, 1);
  return array;
};
...
const paintItRed = function (element) {
  element.style.backgroundColor = "red";
};
a.forEach((element_a) => {
  paintItRed(element_a);
});
...
tr.forEach((element_tr) => element_tr.classList.add("test"));
// [EXTRA] JS Avanzato
